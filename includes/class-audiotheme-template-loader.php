...
class Audiotheme_Template_Loader {
	 ...
	 * @since 2.0.0
	 *
	 * @uses AudioTheme_Template_Loader::get_template_possble_parts()
	 *     Create file names of templates.
	 * @uses AudioTheme_Template_Loader::locate_template() Retrieve the
	 ...
	 * @since 2.0.0
	 *
	 * @uses AudioTheme_Template_Loader::get_template_paths() Return a
