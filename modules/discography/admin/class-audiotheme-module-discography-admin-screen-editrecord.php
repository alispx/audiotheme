 ...
 * @since 2.0.0
 */
class AudioTheme_Module_Discography_Admin_Screen_EditRecord {
	/**
	 *
	 *
	 * @since 2.0.0
	...
	public function render_tracklist_editor( $post ) {
		...
		include( AUDIOTHEME_DIR . 'modules/discography/admin/views/edit-record-tracklist.php' );
		include( AUDIOTHEME_DIR . 'modules/discography/admin/views/templates-record.php' );

		wp_enqueue_script(
			'audiotheme-tracklist-editor',
			AUDIOTHEME_URI . 'modules/discography/admin/js/tracklist-editor.js',
	...
	public function display_field_links( $post ) {
		...
		include( AUDIOTHEME_DIR . 'modules/discography/admin/views/edit-record-links.php' );
	}
