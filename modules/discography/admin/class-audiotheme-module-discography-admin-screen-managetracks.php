 ...
 * @since 2.0.0
 */
class AudioTheme_Module_Discography_Admin_Screen_ManageTracks {
	/**
	 * Load the screen.
	 *
	 * @since 2.0.0
		...
		switch ( $column_name ) {
			...
			case 'download' :
				if ( is_audiotheme_track_downloadable( $post_id ) ) {
					echo '<img src="' . AUDIOTHEME_URI . 'modules/admin/images/download.png" width="16" height="16">';
				}
				break;
			...
			case 'file' :
				...
				if ( $url ) {
					printf( '<a href="%1$s" target="_blank">%2$s</a>',
						esc_url( $url ),
						'<img src="' . AUDIOTHEME_URI . 'modules/admin/images/music-note.png" width="16" height="16">'
					);
				}
				break;
			...
			case 'purchase' :
				...
				if ( $url ) {
					printf( '<a href="%1$s" target="_blank"><img src="' . AUDIOTHEME_URI . 'modules/admin/images/link.png" width="16" height="16"></a>',
						esc_url( $url )
					);
				}
				break;
