 ...
 * @since 2.0.0
 */
class AudioTheme_Module_Discography_Admin {
	/**
	...
	public function load() {
		...
		$screen_manage_records = new AudioTheme_Module_Discography_Admin_Screen_ManageRecords();
		$screen_manage_records->load();

		$screen_edit_record = new AudioTheme_Module_Discography_Admin_Screen_EditRecord();
		$screen_edit_record->load();

		$screen_manage_tracks = new AudioTheme_Module_Discography_Admin_Screen_ManageTracks();
		$screen_manage_tracks->load();

		$screen_edit_track = new AudioTheme_Module_Discography_Admin_Screen_EditTrack();
		$screen_edit_track->load();
	}
	...
	public function print_playlist_templates() {
		include( AUDIOTHEME_DIR . 'modules/discography/admin/views/templates-playlist.php' );
	}
