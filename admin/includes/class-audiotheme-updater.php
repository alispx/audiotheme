...
class Audiotheme_Updater {
	...
	public function get_license_error_messages( $args = array() ) {
		...
		$messages['major_update'] .= sprintf( __( 'This is a major update. Log in to <a href="%s" target="_blank">your account on AudioTheme.com</a> for information about how to access this update.', 'audiotheme' ),
			esc_url( $args['account_url'] )
		);
