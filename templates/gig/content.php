...
<dl id="audiotheme-gig" <?php post_class( array( 'audiotheme-gig-single' ) ) ?> itemscope itemtype="http://schema.org/MusicEvent">
	...
	<?php if ( audiotheme_gig_has_venue() ) : ?>
		...
		<dd class="audiotheme-gig-venue" itemprop="location" itemscope itemtype="http://schema.org/EventVenue">
			<?php
